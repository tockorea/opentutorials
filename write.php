          ...
          <article>
            <form action="process.php" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control span9" name="title" id="form-title" placeholder="제목을 적어주세요.">
              </div>
              <div class="form-group">
                <label for="form-author">작성자</label>
                <input type="text" class="form-control span9" name="author" id="form-author" placeholder="작성자를 적어주세요.">
              </div>
              <div class="form-group">
